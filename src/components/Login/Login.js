...
const Login = () => {
    ...
    return (
        <>
            <div className='login-background' style={{ backgroundImage: "url('/background.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
                {/* <div className='row'>
                ...
                <div className='row'>
                    <div className='login-container'>
                        <div className='login-content'>
                            <div className='col-12 text-login' style={{ color: 'blue' }}>Login</div>
