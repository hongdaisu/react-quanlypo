...
const Role_bak = (props) => {
    ...
    const [columnDefs, setColumnDefs] = useState([
        {
            headerName: 'Action', field: '', pinned: 'left', width: 100, maxWidth: 95,
            lockPosition: true,
            filter: false,
            unSortIcon: false,
            cellRenderer: (params) =>
        ...
        { headerName: 'Chức năng', field: 'action', minWidth: 100 },
    ...
    const receiveDataFromChild = async (data) => {
        ...
        try {
            if (data.checkbox === true) {
                ...
                // console.log('checkgroup.checkgrouprole.length', checkgroup.checkgrouprole.length)
                ...
                <div className='container container-top'>
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            ...
                            <div className="ag-theme-alpine" id='myGrid' style={{ height: '85vh', width: '100%' }}
                            >
                                <AgGridReact
                                    rowData={rowData}
