        ...
        try {
            ...
            if (res_action && res_action.errCode === 0) {
                ...
                if (checkchungtu && checkchungtu.errCode === 0) {
                    const modifiedData = { machungtu: machungtu, sopo: sopo, Nhom: 'xoactpo' };
        ...
        <>
            ...
            <div>
                <ModalXacNhanXoa
                    ...
                    handleCloseXoaChungTuPO={handleCloseXoaChungTuPO}
                    socket={socket}
                />
            </div>
        </>
