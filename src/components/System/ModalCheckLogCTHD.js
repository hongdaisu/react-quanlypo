...
const ModalCheckLogCTHD = (props) => {
    ...
    const handleCloseCheckXoaChungTuHopDong = () => {
    ...
    const handleXoaLogCTHD = async (data) => {
        ...
        try {
            ...
            if (res_action && res_action.errCode === 0) {
                const modifiedData = { machungtu: machungtu, sopo: sopo, Nhom: 'xoacheckcthd' };
        ...
        <>
            ...
            <div>
                <ModalXacNhanXoa
                    ...
                    handleCloseCheckXoaChungTuHopDong={handleCloseCheckXoaChungTuHopDong}
                    socket={socket}
                />
            </div>
        </>
...
export default ModalCheckLogCTHD;